...
// File: contracts/tokens/IFAToken.sol
...
contract IFAToken is ERC20("ifarm.finance", "IFA"), Ownable {
    ...
    /// Must only be called by the owner (CreateIFA).
    /// CreateIFA gurantees the maximum supply of IFA
    ...
    internal
    {
        ...
        uint256 delegatorBalance = balanceOf(delegator); // balance of underlying IFAs (not scaled);
